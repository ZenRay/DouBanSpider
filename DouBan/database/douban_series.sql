...
CREATE TABLE `series_info` (
  ...
  `alias` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '豆瓣影视别名',
  ...
  `release_year` SMALLINT(4) DEFAULT NULL COMMENT '豆瓣影视成片年份',
  `release_date` varchar(600) DEFAULT NULL COMMENT '豆瓣影视上映日期，不同的国家可能日期不同',
  `play_duration` varchar(600) DEFAULT NULL COMMENT '豆瓣影视播放时长，可能不同回家版本存在不同时长',
  `imdb_id` varchar(20) DEFAULT NULL COMMENT 'IMDB 数据中的 ID',
  `tags` varchar(200) DEFAULT NULL COMMENT '豆瓣影视中豆瓣成员常用标签 实际可能为豆瓣处理得到的结果',
  `directors` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '豆瓣影视条目中导演，使用 / 分隔',
  `screenwriters` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '豆瓣影视条目中编剧，使用 / 分隔',
  `actors` varchar(1200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '豆瓣影视条目中演员，使用 / 分隔',
  `plot` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '豆瓣影视条目剧情简介',
  `set_number` int DEFAULT NULL COMMENT '豆瓣影视剧集的总集数',
  ...
  `recommendation_item` varchar(1200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '提取豆瓣对当前内容推荐对相似条目',
  `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '首次爬取数据',
  `update_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新爬取时间，没有更新的情况和首次爬取时间一致',
  PRIMARY KEY (`series_id`)
...
CREATE TABLE `worker` (
  ...
  `action` varchar(20) DEFAULT NULL COMMENT '演员或其他配音演员，参与到影片中到方式',
...
CREATE TABLE `award` (
  ...
  `name` varchar(130) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '获奖类型名称',
...
CREATE TABLE `person` (
  ...
  `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '豆瓣影视演职人员姓名',
  ...
  `birthplace` varchar(260) DEFAULT NULL COMMENT '影视演职人员出生地',
  `profession` varchar(40) DEFAULT NULL COMMENT '演职人员的职业名称，可能使用 / 分隔',
  `alias` varchar(1500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '豆瓣影视演职人员姓名(非中文)',  
  `alias_cn` varchar(240) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '豆瓣影视演职人员姓名(中文)',  
  `family` varchar(1200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '豆瓣影视演职人员家庭成员',   
  `imdb_link` varchar(30) DEFAULT NULL COMMENT 'IMDB 数据中的链接',
  `official_web` varchar(150) DEFAULT NULL COMMENT '影视推广的官方网站',
  `introduction` varchar(6000) DEFAULT NULL COMMENT '人物信息简介',
  `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '首次爬取数据',
  `update_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新爬取时间，没有更新的情况和首次爬取时间一致',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='影视海报和壁纸信息';
